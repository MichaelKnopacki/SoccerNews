...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.tvTitle.setText( news.title );//Carrega o título da notícia
        holder.binding.tvDescription.setText( news.description );//Carrega a descrição da notícia
        ...
        int favoriteColor = news.favorite ? R.color.favorite_active : R.color.favorite_inactive; // Usado um IF ternário
